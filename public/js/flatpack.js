...
/* harmony export */   "notify": () => (/* reexport safe */ _notify__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "taginput": () => (/* reexport safe */ _taginput__WEBPACK_IMPORTED_MODULE_2__["default"])
/* harmony export */ });
/* harmony import */ var _navbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./navbar */ "./resources/js/components/navbar.js");
/* harmony import */ var _notify__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./notify */ "./resources/js/components/notify.js");
/* harmony import */ var _taginput__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taginput */ "./resources/js/components/taginput.js");
...
var notifications = {
  info: function info(message) {
    return toastify_js__WEBPACK_IMPORTED_MODULE_0___default()(_objectSpread(_objectSpread({}, config), {}, {
      style: {
        background: "#3b82f6"
      },
      text: message
...
var suggestionItemTemplate = function suggestionItemTemplate(tagData) {
  return "\n  <div\n    class='tagify__dropdown__item ".concat(tagData["class"] ? tagData["class"] : "", "'\n    tabindex=\"0\"\n    role=\"option\">\n      <strong>").concat(tagData.name, "</strong>\n  </div>\n  ");
};

var taginput = function taginput(key, input, values) {
  var addNewEntries = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  tagify.on("add", function (e) {
    setTimeout(function () {
      ...
      if (isNew) {
        // Create new model
        Livewire.emit("flatpack-taginput:new-tag", key, data.value); // Add to whitelist and sync value

        Livewire.on("flatpack-taginput:new-tag-created:".concat(key), function (value) {
          var newTag = {
            value: value,
            name: "".concat(data.name)
          }; // Update whitelist

          whitelist.push(newTag); // Update tag value
...
window.livewire.on("redirect", function (_ref) {
  var url = _ref.url;
  setTimeout(function () {
...
window.livewire.on("notify", function (event) {
  (0,_components__WEBPACK_IMPORTED_MODULE_0__.notify)(event);
...
var setSetting = function setSetting(setting, value) {
  console.log("".concat(PREFIX, "_").concat(setting), value);
...
/******/ 		var installedChunks = {
/******/ 			"/public/js/flatpack": 0,
/******/ 			"public/css/flatpack": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunklaravel_flatpack"] = self["webpackChunklaravel_flatpack"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["public/css/flatpack"], () => (__webpack_require__("./resources/js/flatpack.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/flatpack"], () => (__webpack_require__("./resources/css/flatpack.css")))
