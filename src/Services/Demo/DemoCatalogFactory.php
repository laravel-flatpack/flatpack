...
namespace Flatpack\Services\Demo;

use function fake;

/**
 * Demo /docs catalog payloads for the in-package component browser (fields, widgets, metadata).
 */
final class DemoCatalogFactory
{
    public function normalizeCatalogId(mixed $value): string
    {
        if (is_string($value)) {
     ...
     */
    public function buildDocument(string $id): array
    {
