...
final readonly class ListController
{
     ...
     * @return array{id: string, scope?: string, reorderable?: bool|string, columns?: mixed, filters?: mixed, bulk_actions?: mixed}|null
     */
    private function resolveActiveTabDefinition(?array $schema, string $requestedTabId): ?array
    {
        ...
        /** @var list<array{id: string, scope?: string, reorderable?: bool|string, columns?: mixed, filters?: mixed, bulk_actions?: mixed}> $panels */
        $panels = [];
    ...
    /**
     * @param  array<string, mixed>|null  $schema
     * @param  array{id: string, scope?: string, reorderable?: bool|string, columns?: mixed, filters?: mixed, bulk_actions?: mixed}|null  $activeTab
