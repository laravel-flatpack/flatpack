...
function ComboboxChipsInput({
    ...
    return (
        <ComboboxPrimitive.Input
            ...
            className={cn('min-w-16 flex-1 outline-none px-2 py-2', className)}
            {...props}
        />
    );
}
