...
function ComboboxContent({
    ...
    return (
        <ComboboxPrimitive.Portal
            {...(portalContainer != null ? { container: portalContainer } : {})}
        >
...
function ComboboxChipsInput({
    ...
    return (
        <ComboboxPrimitive.Input
            ...
            className={cn('min-w-16 flex-1 outline-none px-2 py-1', className)}
            {...props}
        />
    );
}
