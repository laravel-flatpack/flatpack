...
export function flatpackActionVariant(
...
export function flatpackActionIconButtonClass(action: FlatpackActionWithIcon) {
...
function FlatpackActionShortcut({
    shortcut,
    isMacPlatform,
    variant,
}: {
...
type FlatpackActionButtonContentProps = {
...
export function FlatpackActionButtonContent({
    action,
    isMacPlatform,
    variant,
    shortcut,
...
}: FlatpackActionButtonContentProps) {
