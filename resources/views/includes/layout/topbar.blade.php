<div class="top-bar-wrapper">
    <div class="container text-gray-300 mx-auto max-w-[1400px]">
        <div class="flex justify-between items-center gap-5 w-full">
            <div class="flex items-center justify-start gap-2 w-1/2">
                <button 
                    @click="navbar = !navbar"
                    ...
                    class="menu-toggle"
                >
                    <x-icon name="menu" style="solid" class="w-5 h-5 menu-show" />
                    <x-icon name="x" style="solid" class="w-5 h-5 menu-hide" />
                </button>
